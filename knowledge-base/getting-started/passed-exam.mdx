...
<Check>
  Additional steps you will need to take include uploading the following from your account after you've signed up:

  1. Copy of U.S. government issued photo ID (state or federal)
  2. Copy of your exam pass notice

  You'll find the upload tool on the signup success page once you create your account — see [Requirements After Passing Your Exam](/knowledge-base/getting-started/requirements-after-exam) for details.
</Check>
