...
# Here are the most common reasons and how to address them:
 ...
 1. **Poor Agent-Client Match**
    ...
    - Different expectations about process
    ...
    - Ensure agent has relevant market expertise
    - Check agent's communication style matches client's preferences
    - Verify agent's current workload can accommodate new clients
 2. **Inadequate Initial Qualification**
    ...
    _Prevention:_
    - Use detailed qualification checklist
    - Discuss budget and financing upfront
    - Verify pre-approval status for buyers
    - Understand true motivation for moving
