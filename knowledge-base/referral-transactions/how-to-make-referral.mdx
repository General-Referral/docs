...
6. **Closing the deal**. When your deal is closed or a closing date is set, [email the office](https://app.generalreferral.com/dashboard/support). If you're not yet signed up with our payroll provider, we'll send you an invite to create a profile that includes your banking info for direct deposit.
