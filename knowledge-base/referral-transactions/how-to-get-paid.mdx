...
<Frame>
  <iframe 
    width="100%" 
    height="400" 
    src="https://www.youtube.com/embed/owb-Xiq5TKw" 
    frameborder="0" 
    allowfullscreen
  />
</Frame>
...
<Card title="Download W9" icon="file" href="https://drive.google.com/file/d/1EL2ZvK4ewS0fbR2kOgok196nVWU_5mqz/view?usp=drive_link">
  Send this W9 and copy us at support@generalreferral.com
</Card>
...
<Tabs>
  <Tab title="First-Time Setup">
    **After Your First Referral:**
    ...
    3. Set up your banking details for direct deposit
    4. Submit your first disbursement request
    
    <Note>This setup is only required once for your first referral</Note>
  </Tab>
...
We currently use **Square Payroll** to process payments and issue tax forms.

<CardGroup cols={2}>
  <Card title="Square Payroll Login" icon="square" href="https://squareup.com/us/en">
    Access your payroll account
  </Card>
  <Card title="Square Team App" icon="mobile" href="https://squareup.com/help/us/en/article/7060-square-team-app-for-team-members">
...
<Info>
  **1099 Forms:** All agents who earn income during the calendar year will receive a 1099 tax form through Square Payroll, typically available at the end of January.
</Info>
...
<AccordionGroup>
  <Accordion title="How long does the entire process take?">
    From settlement to direct deposit typically takes 1-2 weeks, depending on how quickly the receiving agent sends payment and you submit your disbursement form.
  </Accordion>
