...
<AccordionGroup>
  <Accordion title="Commission Payment Delayed">
    **First, contact the receiving brokerage** to confirm:
    ...
    If unable to resolve, [contact our support team](https://app.generalreferral.com/contact).
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="What if I never received a referral agreement?">
    The agreement might not have been signed by all parties. Contact the receiving agent to ensure all parties signed the referral agreement.
    The agreement might not have been signed by all parties. Contact the receiving agent to ensure they completed the SignWell process.
  </Accordion>
</AccordionGroup>
