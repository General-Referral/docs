...
<AccordionGroup>
  <Accordion title="How long does the entire process take?">
    From settlement to direct deposit typically takes 2 weeks, but depends heavily on how quickly the receiving agent sends payment and you submit your disbursement form.
  </Accordion>
